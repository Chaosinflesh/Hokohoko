...
class SpeculativeAccuracy(Assessor):
    """
    Uses the method from Bradley *et al* to assess the accuracy of FOREX prediction algorithms. See
    :ref:`speculative_accuracy` for specifics. Can be provided the following options via
    ``HokohokoConfig.assessor_parameters``:
    ...
    It is intended for use with benchmarking.
